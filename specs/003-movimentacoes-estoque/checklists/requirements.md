# Checklist de Qualidade da Especificação: Movimentações de Estoque
...
- [x] Cenários de uso cobrem fluxos principais (Entrada, Saída, Ajuste, Histórico)
...
- Tipos de movimentação: Entrada, Saída, Ajuste Manual
- Rastreabilidade completa conforme princípio da Constituição
- Suposições documentadas: atomicidade, timezone, etc.
